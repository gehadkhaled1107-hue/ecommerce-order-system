...
Final integration point. Combines:
  person1.py   -> Product hierarchy (PhysicalProduct/DigitalProduct/Service),
...
# (lives here, not in person1.py, to avoid a circular import:
#  checkout.py already imports FROM person1.py)
# ============================================================
...
def load_sample_data(product_manager, order_processing_manager):
    ...
    load_sample_products(product_manager)  # from person1.py: 5 sample products
...
def main():
    product_manager = OrderManager()          # products + customers container (person1.py)
